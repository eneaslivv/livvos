  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-5">
        <h3 className="text-xs font-semibold text-zinc-400 dark:text-zinc-500 uppercase tracking-wider">Financial Summary</h3>
      ...
      {/* Total */}
      <div className="mb-5">
        <p className="text-[10px] text-zinc-400 dark:text-zinc-500 font-medium mb-1">Total value</p>
      ...
      <div className="mb-5">
        <div className="flex justify-between text-[10px] mb-1.5">
          <span className="text-zinc-400 dark:text-zinc-500">Payment progress</span>
      ...
      {budget.nextPayment && (
        <div className="p-3 bg-amber-50/80 dark:bg-amber-950/40 border border-amber-200/40 dark:border-amber-800/40 rounded-xl mb-4">
          <div className="flex items-center gap-1.5 mb-1">
            ...
            <p className="text-[9px] font-semibold text-amber-600 dark:text-amber-400 uppercase tracking-wider">Next Payment</p>
          </div>
          <div className="flex items-end justify-between">
            <div>
              <p className="text-[9px] text-amber-500 dark:text-amber-400 mb-0.5">{budget.nextPayment.concept || 'Pending installment'}</p>
      ...
      <div className="grid grid-cols-2 gap-2.5 mt-auto">
        <div className="p-3.5 bg-[#2C0405]/5 dark:bg-[#822b2e]/15 rounded-xl">
          <p className="text-[10px] text-[#2C0405]/60 dark:text-[#e8a0a2]/60 font-medium mb-1">Paid</p>
        ...
        <div className="p-3.5 bg-zinc-50 dark:bg-zinc-800 rounded-xl">
          <p className="text-[10px] text-zinc-400 dark:text-zinc-500 font-medium mb-1">Remaining</p>
