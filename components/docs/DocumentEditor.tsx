...
export const DocumentEditor: React.FC<DocumentEditorProps> = ({ documentId, onClose }) => {
  ...
  const slashItems = useMemo<SlashItem[]>(() => [
    ...
    },
    {
      ...
      hint: 'Big heading',
      icon: 'Hash',
      keywords: ['h1', 'heading', 'header', 'title'],
    ...
    },
    {
      ...
      hint: 'Medium heading',
      icon: 'Hash',
      keywords: ['h2', 'heading', 'header', 'title'],
    ...
    },
    {
      ...
      hint: 'Small heading',
      icon: 'Hash',
      keywords: ['h3', 'heading', 'header', 'title'],
    ...
    },
    {
      ...
      icon: 'ListChecks',
      keywords: ['checklist', 'todo', 'task list', 'tasks'],
    ...
    },
    {
      id: 'table',
      label: 'Table',
      hint: '3x3 table with checkboxes',
      icon: 'Table',
      keywords: ['table', 'grid'],
      run: (ed, range) => {
