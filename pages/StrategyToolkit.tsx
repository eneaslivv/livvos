  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-6">
      <header className="mb-5">
        <h1 className="text-2xl font-bold text-zinc-900 dark:text-zinc-100 tracking-tight">Strategy Toolkit</h1>
        <p className="text-sm text-zinc-500 dark:text-zinc-400 mt-1">
          Frameworks you use internally, productized as client deliverables. Each framework =
          a sellable engagement with pricing + hours + outputs.
        </p>
      </header>
