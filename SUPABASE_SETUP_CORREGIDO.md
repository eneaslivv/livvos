...
-- SAMPLE DATA (CORREGIDO - sin UUIDs inválidos)
...
6. **¡Listo!** Las tablas y datos de prueba estarán creados

## Verificación rápida:

Después de ejecutar el SQL, puedes verificar que funcionó:

1. Ve a "Table Editor" en el menú lateral
2. Deberías ver las tablas: `projects`, `ideas`, `leads`, `activity_logs`, `web_analytics`
3. Haz clic en cada tabla para ver los datos de muestra

## Si hay algún error:

- **Copia el mensaje de error exacto** y compártelo conmigo
...
¡Tu aplicación está casi lista! 🎉

Una vez que ejecutes el SQL, actualiza la página http://localhost:3000 y deberías ver los datos reales de tu base de datos.