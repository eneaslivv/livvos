 -- MIGRACIONES CONSOLIDADAS ENEAS-OS
...
DROP POLICY IF EXISTS "View Tasks Optimized" ON tasks;
CREATE POLICY "View Tasks Optimized" ON tasks
FOR SELECT
USING (
  has_permission('projects', 'view_all')
  OR
...
-- ============================================
-- INSTRUCCIONES FINALES: ASIGNAR ROL OWNER
-- ============================================
-- 1. Copia tu UUID de la tabla auth.users
-- 2. Ejecuta: INSERT INTO user_roles (user_id, role_id) SELECT 'TU-UUID-AQUI', id FROM roles WHERE name = 'owner';
