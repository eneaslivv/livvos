...
ALTER TABLE invitations ADD COLUMN IF NOT EXISTS type TEXT DEFAULT 'team';
ALTER TABLE invitations ADD COLUMN IF NOT EXISTS client_id UUID REFERENCES clients(id) ON DELETE SET NULL;
