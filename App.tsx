...
const loadPlatformSalesAgent = () => retryDynamicImport(() => import('./pages/PlatformSalesAgent').then(m => ({ default: m.PlatformSalesAgent })), 'PlatformSalesAgent');
...
const PlatformSalesAgent = React.lazy(loadPlatformSalesAgent);
    ...
    >
      {!isReady ? (
        ...
        <>
          ...
          {visitedPages.has('projects') && (
            <KeepAlivePage page="projects" active={currentPage === 'projects'}>
              <ProtectedRoute permission={{ module: 'projects', action: 'view' }} feature="projects_module">
                <Projects navParams={navParams} onNavigate={handleNavigate} />
              </ProtectedRoute>
            </KeepAlivePage>
          )}
          ...
          {/* Platform Sales Agent — commercial agent + tier catalog + onboarding wizard */}
          {visitedPages.has('platform_sales_agent') && (
            <KeepAlivePage page="platform_sales_agent" active={currentPage === 'platform_sales_agent'}>
              <PlatformSalesAgent />
            </KeepAlivePage>
          )}
          ...
          {/* Strategy Toolkit — framework library + client strategy projects */}
          {visitedPages.has('strategy_toolkit') && (
            <KeepAlivePage page="strategy_toolkit" active={currentPage === 'strategy_toolkit'}>
              <StrategyToolkit />
            </KeepAlivePage>
          )}
